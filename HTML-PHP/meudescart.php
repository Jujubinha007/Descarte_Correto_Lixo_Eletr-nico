...
<nav  class="menu">
  ...
  <path d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm-1-5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zM4 8a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm0 2.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z"/>
        ...
        <a href="excluir.php"><h5 onclick="abrirModal()"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
...
<?php 
include_once('conexao.php');
$sqlconsulta = "SELECT * FROM descarte where email='$email'";
...
?>
  ...
  <tr>
    <td scope="row"><?php echo $dados['local']; ?></td>
    <td scope="row"><?php echo $dados['descr']; ?></td>
    <td scope="row"><?php echo $dados['tipop']; ?></td>
    <td scope="row"><?php echo $dados['marca']; ?></td>
    <td scope="row"><?php echo $dados['tempo']; ?></td>

    <td><a href="atuadesc.php?id=<?php echo $dados['id']; ?>" class="#"><button type="button" class="btn btn-info"><i class="fa-solid fa-pen"></i></button></a></td>
    <td><a href="excludesc.php?id=<?php echo $dados['id']; ?>" class="#"><button type="button" class="btn btn-danger"><i class="fa-solid fa-trash"></i></button></a></td>
